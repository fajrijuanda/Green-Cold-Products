    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4 me-xl-8">
        ...
        <a href="{{url('login')}}" class="app-brand-link">
          ...
          <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">Green Cold Products</span>
        </a>
      </div>
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!-- navbar button: Start -->
        {{-- <li>
          <a href="{{url('/login')}}" class="btn btn-primary" target="_blank"><span class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Login</span></a>
        </li> --}}
        <!-- navbar button: End -->
      </ul>
      <!-- Toolbar: End -->
