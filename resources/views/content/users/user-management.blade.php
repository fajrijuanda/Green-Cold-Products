                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <div class="d-flex align-items-center my-1">
                                ...
                                <p class="text-success mb-0">(+{{ $verifiedPercentage }}%)</p>
                            </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <div class="d-flex align-items-center my-1">
                                ...
                                <p class="text-success mb-0">(+{{ $duplicatePercentage }}%)</p>
                            </div>
                            <small class="mb-0">Recent analytics</small>
                        </div>
                        <div class="avatar">
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            ...
                            <div class="d-flex align-items-center my-1">
                                ...
                                <p class="text-danger mb-0">(+{{ $notVerifiedPercentage }}%)</p>
                            </div>
                            <small class="mb-0">Recent analytics</small>
                        </div>
                        <div class="avatar">
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form class="add-new-user pt-0" id="addNewUserForm">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" class="form-control" id="add-user-project" placeholder="Project"
                            name="project" aria-label="Project" required />
                    </div>
